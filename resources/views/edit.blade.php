      ...
      {{ csrf_field() }}
        ...
        <div class="formularz">
          ...
          <input
            ...
            pattern="[0-9]{9}"
            value="{{ $order[0]->telefon }}"
          />
          <label for="strona">Strona WWW</label>
          <input type="text" name="www" id="strona" required placeholder="" value="{{ $order[0]->www }}">
          ...
          <button type="submit" class="przycisk-formularz">Zmień zamówienie</button>
